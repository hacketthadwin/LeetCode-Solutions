# WHY DP IS NOT THE CORRECT SOLUTION AND BFS IS?

# Intuition
THIS IS GRAPH PROBLEM NOT DP PROBLEM BECAUSE WE CAN GO BACK ALSO, AND IF WE CAN GO BACK IT MEANS IT IS CYCLIC, DP CANNOT BE PERFORMED ON A CYCLIC GRAPH
