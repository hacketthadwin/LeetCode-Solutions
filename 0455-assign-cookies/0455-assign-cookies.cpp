...
public:
    int findContentChildren(vector<int>& players, vector<int>& trainers) {
        ...
        //my approach is for each player i will do lower bound to find the maximum index of trainer it can train from, then i will keep checking the players to find if they matched correctly or not with the player they can train from
